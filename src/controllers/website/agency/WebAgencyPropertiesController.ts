...
} from "@/routes/website/agency/validations/AgencyPropertyRouterValidation";
...
class WebAgencyPropertiesControllerClass {
...
export const WebAgencyPropertiesController = new WebAgencyPropertiesControllerClass();
